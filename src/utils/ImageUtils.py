...
# # Example Usage
# H, W, slices = 512, 256, 20  # Example values
# arr1 = np.random.rand(H, W)  # First array with fixed shape (H, W)
# arr2 = np.random.rand(slices, 512, 256)  # Second array in any permutation

# arr2_fixed = reshape_to_HW_slices(arr1, arr2)

# print("Original shape:", arr2.shape)
# print("Fixed shape:", arr2_fixed.shape)  # Should be (H, W, slices)
